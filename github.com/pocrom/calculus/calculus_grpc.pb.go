...
const (
	Calculate_Add_FullMethodName = "/calculus.Calculate/Add"
	Calculate_Sub_FullMethodName = "/calculus.Calculate/Sub"
)
...
type CalculateClient interface {
	Add(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Result, error)
	Sub(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculateClient) Add(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, Calculate_Add_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculateClient) Sub(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, Calculate_Sub_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculateServer interface {
	Add(context.Context, *Data) (*Result, error)
	Sub(context.Context, *Data) (*Result, error)
...
func (UnimplementedCalculateServer) Add(context.Context, *Data) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedCalculateServer) Sub(context.Context, *Data) (*Result, error) {
...
func _Calculate_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculateServer).Add(ctx, req.(*Data))
	}
...
func _Calculate_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Calculate_Sub_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculateServer).Sub(ctx, req.(*Data))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Calculate_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calculus.Calculate",
